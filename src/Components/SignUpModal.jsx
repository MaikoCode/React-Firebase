                        ...
                        <div className='modal-content'>
                            ...
                            <form className='sign-up-form'>
                                <div className='mb-3'>
                                    ...
                                    <input name="email" type="email" className='form-control' id='signUpEmail' required />
                                </div>

                                <div className='mb-3'>
                                    <label htmlFor="signUpPwd" className='form-label'>Password</label>
                                    <input name="pwd" type="password" className='form-control' id='signUpPwd' required />
                                </div>

                                <div className='mb-3'>
                                    <label htmlFor="repeatPwd" className='form-label'>Repeat Password</label>
                                    <input name="pwd" type="password" className='form-control' id='repeatPwd' required />
